...
GGML implementation of the three-layer audio CNN plus `conv_out`. The remaining
native work is to port the audio transformer/projector and Qwen3 decoder/KV
cache into GGML.
